...
# DATA INGESTION
trial_1 <- readr::read_csv("Data/Trial-1/Training_Forecast.csv")
trial_2 <- readr::read_csv("Data/Trial-2/Training_Forecast.csv")
trial_3 <- readr::read_csv("Data/Trial-3/Training_Forecast.csv")
trial_4 <- readr::read_csv("Data/Trial-4/Training_Forecast.csv")
trial_5 <- readr::read_csv("Data/Trial-5/Training_Forecast.csv")
...
ggplot() + 
	...
	labs(title = "Dissolved Oxygen Concentration Forecast",
		 subtitle = "Training Split: June 2006 - May 2020",
		 x = "Date",
		 y = latex2exp::TeX("Concentration $\\left(\\frac{mg}{L} \\right)$")) + 
	theme_bw()
ggsave("Figures/Training_Forecast_Dissolved_Oxygen_Concentration.pdf", height = 6, 
	width = 15, scale = 0.8)
...
ggplot() + 
	...
	theme_bw()
ggsave("Figures/Training_Forecast_Water_Temperature.pdf", height = 6, 
	width = 15, scale = 0.8)
