...
# DATA INGESTION
trial_1 <- readr::read_csv("Data/Trial-1/Testing_Forecast.csv")
trial_2 <- readr::read_csv("Data/Trial-2/Testing_Forecast.csv")
trial_3 <- readr::read_csv("Data/Trial-3/Testing_Forecast.csv")
trial_4 <- readr::read_csv("Data/Trial-4/Testing_Forecast.csv")
trial_5 <- readr::read_csv("Data/Trial-5/Testing_Forecast.csv")
...
ggplot() + 
	...
	labs(title = "Dissolved Oxygen Concentration Forecast",
		 subtitle = "Testing Split: February 2022 - November 2023",
		 x = "Date",
		 y = latex2exp::TeX("Concentration $\\left(\\frac{mg}{L} \\right)$")) + 
	theme_bw()
ggsave("Figures/Testing_Forecast_Dissolved_Oxygen_Concentration.pdf", 
...
ggplot() + 
	...
	theme_bw()
ggsave("Figures/Testing_Forecast_Water_Temperature.pdf", height = 6, 
	width = 15, scale = 0.8)
